...
from user_management.tokens import account_activation_token
...
class UserLoginView(LoginView):
        ...
        #             or reverse('users_profile', kwargs={'pk': self.user_management.pk})
        #     )
        #     return ret
...
class UserProfileView(UpdateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if request.user.pk:
            ...
            pk = kwargs['pk']
        return HttpResponseRedirect(reverse('users_profile', kwargs={'pk': pk}))
